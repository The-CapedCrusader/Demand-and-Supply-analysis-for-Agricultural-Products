...
const PriceComparisonChart = () => (
  <div className="h-80 w-full rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 flex items-center justify-center">
    <span className="text-muted-foreground">Price Comparison Chart</span>
  </div>
);

const WeatherForecast = () => (
  <div className="h-64 w-full rounded-lg bg-gradient-to-r from-amber-50 to-yellow-50 flex items-center justify-center">
    <span className="text-muted-foreground">Weather Forecast Visualization</span>
  </div>
);

const CropYieldChart = () => (
  <div className="h-64 w-full rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 flex items-center justify-center">
    <span className="text-muted-foreground">Crop Yield Comparison</span>
  </div>
);

const MarketTrends = () => (
  <div className="h-64 w-full rounded-lg bg-gradient-to-r from-purple-50 to-fuchsia-50 flex items-center justify-center">
            ...
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              <div className="px-4 lg:px-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Monitor crop prices, market trends, and optimize your farm's production
                </p>
                ...
                <Tabs defaultValue="market" className="mb-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>Compare crop prices over time</CardDescription>
                        </CardHeader>
                        <CardContent>
                      ...
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>Recent market movement analysis</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <MarketTrends />
                        </CardContent>
                  ...
                  <TabsContent value="crops" className="mt-0">
                    <div className="grid gap-4 md:grid-cols-2">
                      <Card>
                        <CardHeader>
                          <CardTitle className="text-lg">Crop Yield Comparison</CardTitle>
                          <CardDescription>Compare yields across different crops</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <CropYieldChart />
                        </CardContent>
                      ...
                      <Card>
                        <CardHeader>
                          <CardTitle className="text-lg">Harvest Projections</CardTitle>
                          <CardDescription>Projected yields for next harvest</CardDescription>
                        </CardHeader>
                        <CardContent>
              ...
              <div className="px-4 lg:px-6">
                <h2 className="mb-4 text-xl font-semibold">Dashboard Sections</h2>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                  <Link to="/my-farm" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-green-500">
                      <CardHeader className="pb-2">
                      ...
                      <CardContent>
                        <p className="text-muted-foreground text-sm">
                          Monitor your farm's performance, crop health, and weather conditions
                        </p>
                      </CardContent>
                  ...
                  <Link to="/market-analysis" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-blue-500">
                      ...
                      <CardContent>
                        <p className="text-muted-foreground text-sm">
                          Track price trends, market demand, and make data-driven decisions
                        </p>
                      </CardContent>
                      <CardFooter className="pt-0">
                        <span className="text-sm text-primary">View details →</span>
                  ...
                  <Link to="/crop-management" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-amber-500">
                      <CardHeader className="pb-2">
                        <CardTitle className="flex items-center gap-2">
                  ...
                  <Link to="/buyers-sellers" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-purple-500">
                      <CardHeader className="pb-2">
                        <CardTitle className="flex items-center gap-2">
                      ...
                      <CardContent>
                        <p className="text-muted-foreground text-sm">
                          Connect with potential buyers and sellers in your region
                        </p>
                      </CardContent>
                      <CardFooter className="pt-0">
                        <span className="text-sm text-primary">View details →</span>
                  ...
                  <Link to="/crop-database" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-indigo-500">
                      <CardHeader className="pb-2">
                        <CardTitle className="flex items-center gap-2">
                  ...
                  <Link to="/inventory-scanner" className="block">
                    <Card className="hover:bg-muted/50 transition-colors border-l-4 border-l-rose-500">
                      <CardHeader className="pb-2">
                        <CardTitle className="flex items-center gap-2">
