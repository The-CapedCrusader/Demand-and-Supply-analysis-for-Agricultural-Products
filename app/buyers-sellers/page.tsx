...
import { IconSearch, IconStar, IconMessage, IconPhone } from "@tabler/icons-react"
          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              <div className="px-4 lg:px-6">
                <h1 className="text-2xl font-bold mb-2">Buyers & Sellers</h1>
                <p className="text-muted-foreground mb-6">Connect with buyers and suppliers in your network</p>
              </div>
                ...
                <TabsContent value="buyers" className="mt-0">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      <Input placeholder="Search buyers..." className="max-w-sm" />
                    ...
                    <Card>
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Companies and individuals interested in your products</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                          <div className="bg-muted/20 p-4 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                              <div className="flex items-center gap-2">
                                <h3 className="font-medium">Green Valley Organics</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                              <div>
                                ...
                                <p className="font-medium">Organic Rice, Wheat</p>
                              </div>
                              <div>
                          ...
                          <div className="bg-muted/20 p-4 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                              <div className="flex items-center gap-2">
                                <h3 className="font-medium">Midwest Grain Processing</h3>
                                <Badge className="bg-green-100 text-green-800 border-0">Verified</Badge>
                              </div>
                              <div className="flex text-amber-500">
                                <IconStar className="h-4 w-4" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                              <div>
                                <p className="text-sm text-muted-foreground">Interested In</p>
                                <p className="font-medium">Corn, Soybeans, Wheat</p>
                              </div>
                              <div>
                                <p className="text-sm text-muted-foreground">Last Purchase</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <Card>
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Companies that provide seeds, fertilizers and equipment</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                          <div className="bg-muted/20 p-4 rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                              <div>
                                ...
                                <p className="font-medium">Seeds, Fertilizers, Tools</p>
                              </div>
                              <div>
                          ...
                          <div className="bg-muted/20 p-4 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                              <div className="flex items-center gap-2">
                                <h3 className="font-medium">Farm Equipment Inc.</h3>
                                <Badge className="bg-green-100 text-green-800 border-0">Verified</Badge>
                              </div>
                              <div className="flex text-amber-500">
                                <IconStar className="h-4 w-4" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                              <div>
                                <p className="text-sm text-muted-foreground">Products</p>
                                <p className="font-medium">Tractors, Irrigation Systems</p>
                              </div>
                              <div>
                                <p className="text-sm text-muted-foreground">Last Order</p>
                ...
                <TabsContent value="marketplace" className="mt-0">
                  <Card>
                    <CardHeader className="pb-2">
                      ...
                      <CardDescription>Connect with new buyers and sellers in your area</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="bg-muted/20 p-8 rounded-lg text-center">
                        <p className="text-muted-foreground mb-4">Marketplace data would be displayed here</p>
                        <Button>
                          Browse Marketplace
                        </Button>
                      </div>
